...
int	main()
{
  ...
  data1 = mlx_get_pars_addr(im1,&bpp1,&sl1,&endian1);
  ...
  data3 = mlx_get_pars_addr(im3,&bpp3,&sl3,&endian3);
  ...
  data2 = mlx_get_pars_addr(im2,&bpp2,&sl2,&endian2);
  ...
  data4 = mlx_get_pars_addr(im4,&bpp4,&sl4,&endian4);
